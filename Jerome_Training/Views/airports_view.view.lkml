view: airports_view {
  sql_table_name: `vert-298006.faa.airports`
    ;;
  drill_fields: [id]
  ...
  # Create dimension from existing dimension
  # When ${TABLE}.column is used, looker parser looks in the current view. If ${column} is used, colun is directly referenced.
  dimension: full_name {
    type: string
    sql: ${TABLE}.full_name ;;
  }
